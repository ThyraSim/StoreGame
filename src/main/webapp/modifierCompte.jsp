...
<fmt:bundle basename="MessagesBundle">
  ...
  <jsp:include page="background.jsp"/>
    ...
    <form id="registrationForm" action="/ModifierCompteServlet" method="post">
      ...
      <input type="text" id="username" name="username" value="${loggedInAccount.user}" required><br>

      <label for="profileName"><fmt:message key="profileNameTableHeader" />:</label>
      <input type="text" id="profileName" name="profileName" value="${loggedInAccount.profileName}" required><br>

      <label for="password"><fmt:message key="passwordTableHeader" />:</label>
      <input type="password" id="password" name="password" value="${loggedInAccount.password}" required><br>
      ...
      <input type="text" id="physique" name="physique" value="${client.adressePhysique}" required><br>

      <label for="email"><fmt:message key="adressEmTableHeader" />:</label>
      <input type="text" id="email" name="email" value="${client.adresseCourriel}" required><br>
